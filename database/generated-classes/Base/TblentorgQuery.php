 ...
 *
 * @method     ChildTblentorgQuery leftJoinTblentrcp($relationAlias = null) Adds a LEFT JOIN clause to the query using the Tblentrcp relation
 * @method     ChildTblentorgQuery rightJoinTblentrcp($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Tblentrcp relation
 * @method     ChildTblentorgQuery innerJoinTblentrcp($relationAlias = null) Adds a INNER JOIN clause to the query using the Tblentrcp relation
 *
 * @method     ChildTblentorgQuery joinWithTblentrcp($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Tblentrcp relation
 *
 * @method     ChildTblentorgQuery leftJoinWithTblentrcp() Adds a LEFT JOIN clause and with to the query using the Tblentrcp relation
 * @method     ChildTblentorgQuery rightJoinWithTblentrcp() Adds a RIGHT JOIN clause and with to the query using the Tblentrcp relation
 * @method     ChildTblentorgQuery innerJoinWithTblentrcp() Adds a INNER JOIN clause and with to the query using the Tblentrcp relation
 *
...
abstract class TblentorgQuery extends ModelCriteria
{
    ...
    public function filterByTblentrcp($tblentrcp, $comparison = null)
    {
        if ($tblentrcp instanceof \Tblentrcp) {
            return $this
                ->addUsingAlias(TblentorgTableMap::COL_IDNENTORG, $tblentrcp->getIdnentorg(), $comparison);
